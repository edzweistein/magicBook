...
/**
 * <b>XspfAnythingAnyElement</b> is generated from xspf.rng by Relaxer.
...
public class XspfAnythingAnyElement
    ...
    private String $localName$ = "anythingAnyElement";

    /**
     * Creates a <code>XspfAnythingAnyElement</code>.
     *
     */
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the Stack <code>stack</code>
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the File <code>file</code>.
     *
     * @param file
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Creates a <code>XspfAnythingAnyElement</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>XspfAnythingAnyElement</code>.
     *
     * @param element
     * @return boolean
     */
     ...
     * is valid for the <code>XspfAnythingAnyElement</code>.
     ...
     */
    public Object clone() {
        return (new XspfAnythingAnyElement((XspfAnythingAnyElement)this));
    }
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the XspfAnythingAnyElement <code>source</code>.
     *
     * @param source
     */
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>XspfAnythingAnyElement</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
